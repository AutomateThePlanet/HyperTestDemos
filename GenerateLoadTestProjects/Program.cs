...
namespace GenerateLoadTestProjects
{
    public class Program
    {
        ...
        ////    var deployLocation = @"C:\SourceCode\Meissa\NUnitLoadTest\";
        ...
        ////            sb.AppendLine("        {");
        ////            sb.AppendLine("            Thread.Sleep(10);");
        ////            sb.AppendLine("        }");
        ////        }
        ////        sb.AppendLine("    }");
        ////        sb.AppendLine("}");
        ////        var fileLocation = Path.Combine(deployLocation, $"Check{i}Tests.cs");
        ...
        private static void GenerateLoadTestsMsTest()
        {
            ...
            var deployLocation = @"D:\SourceCode\Meissa\HyperTestDemo";
            for (var i = 1; i < numberOfTestFiles; i++)
            {
                var sb = new StringBuilder();
                sb.AppendLine("using System;");
